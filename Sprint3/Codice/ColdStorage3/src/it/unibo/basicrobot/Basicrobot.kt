		  ...
		  var StepSynchRes  = false
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t057",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t058",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t059",targetState="endwork",cond=whenDispatch("end"))
				}	 
