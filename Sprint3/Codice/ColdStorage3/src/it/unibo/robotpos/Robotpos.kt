		 ...
		 val planner = unibo.planner23.Planner23Util()
				...
				state("waitclientrequest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t049",targetState="getRobotState",cond=whenRequest("getrobotstate"))
					transition(edgeName="t050",targetState="planTheRobotmoves",cond=whenRequest("moverobot"))
					transition(edgeName="t051",targetState="setTheRobotState",cond=whenDispatch("setrobotstate"))
					transition(edgeName="t052",targetState="setTheDirection",cond=whenDispatch("setdirection"))
				}	 
				...
				state("setTheDirection") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t053",targetState="planfordirok",cond=whenReply("doplandone"))
					transition(edgeName="t054",targetState="fatalerror",cond=whenReply("doplanfailed"))
				}	 
				...
				state("planTheRobotmoves") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t055",targetState="endok",cond=whenReply("doplandone"))
					transition(edgeName="t056",targetState="endko",cond=whenReply("doplanfailed"))
				}	 
