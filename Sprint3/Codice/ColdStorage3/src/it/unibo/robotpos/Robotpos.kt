		 ...
		 val planner = unibo.planner23.Planner23Util()
				...
				state("waitclientrequest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t044",targetState="getRobotState",cond=whenRequest("getrobotstate"))
					transition(edgeName="t045",targetState="planTheRobotmoves",cond=whenRequest("moverobot"))
					transition(edgeName="t046",targetState="setTheRobotState",cond=whenDispatch("setrobotstate"))
					transition(edgeName="t047",targetState="setTheDirection",cond=whenDispatch("setdirection"))
				}	 
				...
				state("setTheDirection") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t048",targetState="planfordirok",cond=whenReply("doplandone"))
					transition(edgeName="t049",targetState="fatalerror",cond=whenReply("doplanfailed"))
				}	 
				...
				state("planTheRobotmoves") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t050",targetState="endok",cond=whenReply("doplandone"))
					transition(edgeName="t051",targetState="endko",cond=whenReply("doplanfailed"))
				}	 
