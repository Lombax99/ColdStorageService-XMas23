			...
			var Peso = 0
				...
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="ready19",targetState="work",cond=whenDispatch("robotready"))
				}	 
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="startworking20",targetState="startjob",cond=whenRequest("doJob"))
				}	 
				...
				state("movingtoarrival") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="gofetch21",targetState="movingtocoldroom",cond=whenReply("moverobotdone"))
				}	 
				state("movingtocoldroom") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="godrop22",targetState="checkforjob",cond=whenReply("moverobotdone"))
				}	 
				...
				state("waitforjob") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="gofetchagain23",targetState="goinghome",cond=whenTimeout("local_tout_transporttrolley_waitforjob"))   
					transition(edgeName="gofetchagain24",targetState="startjob",cond=whenRequest("doJob"))
				}	 
