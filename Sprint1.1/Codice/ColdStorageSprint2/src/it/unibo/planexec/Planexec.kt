		  ...
		  var Plan          = ""
				...
				state("execplan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="nextMove",cond=whenTimeout("local_tout_planexec_execplan"))   
					transition(edgeName="t027",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
				}	 
				state("nextMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t028",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
				...
				state("doMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
