		 ...
		 val planner = unibo.planner23.Planner23Util()
				...
				state("waitclientrequest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t035",targetState="getRobotState",cond=whenRequest("getrobotstate"))
					transition(edgeName="t036",targetState="planTheRobotmoves",cond=whenRequest("moverobot"))
					transition(edgeName="t037",targetState="setTheRobotState",cond=whenDispatch("setrobotstate"))
					transition(edgeName="t038",targetState="setTheDirection",cond=whenDispatch("setdirection"))
				}	 
				...
				state("setTheDirection") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t039",targetState="planfordirok",cond=whenReply("doplandone"))
					transition(edgeName="t040",targetState="fatalerror",cond=whenReply("doplanfailed"))
				}	 
				...
				state("planTheRobotmoves") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t041",targetState="endok",cond=whenReply("doplandone"))
					transition(edgeName="t042",targetState="endko",cond=whenReply("doplanfailed"))
				}	 
