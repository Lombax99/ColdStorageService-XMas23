...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     controller >> Edge(minlen="1", color='magenta', style='solid', xlabel='<doJob<font color="darkgreen"> jobdone robotDead</font> &nbsp; >',  fontcolor='magenta') >> transporttrolley
     tickethandler >> Edge(minlen="1", color='magenta', style='solid', xlabel='<weightrequest<font color="darkgreen"> weightOK weightKO</font> &nbsp; >',  fontcolor='magenta') >> coldroom
     controller >> Edge(minlen="1", color='blue', style='solid',  xlabel='<updateWeight &nbsp; >',  fontcolor='blue') >> coldroom
     tickethandler >> Edge(minlen="1", color='blue', style='solid',  xlabel='<updateWeight &nbsp; >',  fontcolor='blue') >> coldroom
diag
