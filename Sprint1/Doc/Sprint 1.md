...
- ==ColdRoom Container==: Elemento fisico presente all'interno della Service Area in una posizione fissa (posizione attraverso la quale il robot non può muoversi). In questo elemento è possibile depositare 
- ==DDR robot==:
- ==transport trolley==:
- ==HOME location==:
- ==food-load==:
