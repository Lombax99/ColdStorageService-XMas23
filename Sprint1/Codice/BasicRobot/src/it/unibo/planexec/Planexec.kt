		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t03",targetState="execplan",cond=whenRequest("doplan"))
				}	 
				state("execplan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="nextMove",cond=whenTimeout("local_tout_planexec_execplan"))   
					transition(edgeName="t05",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
				}	 
				state("nextMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
					transition(edgeName="t07",targetState="doMove",cond=whenDispatch("nextmove"))
				}	 
				state("doMove") { //this:State
					...
					transition(edgeName="t012",targetState="planinterruptedobstacle",cond=whenReply("stepfailed"))
				}	 
