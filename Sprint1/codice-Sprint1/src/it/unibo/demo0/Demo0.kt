		...
		return { //this:ActionBasciFsm
				...
				state("mockRequest") { //this:State
					action { //it:State
						...
						CommUtils.outblack("current weight: $KG")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_mockRequest", 
				 	 					  scope, context!!, "local_tout_demo0_mockRequest", 2000.toLong() )
					}	 	 
					 transition(edgeName="repeat0",targetState="mockRequest",cond=whenTimeout("local_tout_demo0_mockRequest"))   
				}	 
			}
		}
}
