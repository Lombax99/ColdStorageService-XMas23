		  ...
		  var Plan          = ""
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t027",targetState="stoppedwhilenothing",cond=whenDispatch("stopplan"))
					transition(edgeName="t028",targetState="work",cond=whenDispatch("continueplan"))
				...
				state("stoppedwhilenothing") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="stoppedwhilenothing",cond=whenDispatch("stopplan"))
					transition(edgeName="t031",targetState="work",cond=whenDispatch("continueplan"))
				}	 
				state("execplan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="nextMove",cond=whenTimeout("local_tout_planexec_execplan"))   
				}	 
				...
				state("doMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="planinterruptedalarm",cond=whenDispatch("stopplan"))
				...
				state("stopped") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="waitingforrestart39",targetState="stopped",cond=whenDispatch("stopplan"))
					transition(edgeName="waitingforrestart40",targetState="moving",cond=whenDispatch("continueplan"))
				}	 
				state("moving") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t141",targetState="nextMove",cond=whenReply("stepdone"))
					transition(edgeName="t142",targetState="nextMove",cond=whenDispatch("nextmove"))
					transition(edgeName="t143",targetState="execplan",cond=whenRequest("doplan"))
				}	 
			}
		}
} 
