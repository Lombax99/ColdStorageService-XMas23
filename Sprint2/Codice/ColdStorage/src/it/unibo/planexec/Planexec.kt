		  ...
		  var Plan          = ""
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t033",targetState="stoppedwhilenothing",cond=whenDispatch("stopplan"))
					transition(edgeName="t034",targetState="work",cond=whenDispatch("continueplan"))
					transition(edgeName="t035",targetState="execplan",cond=whenRequest("doplan"))
				}	 
				state("stoppedwhilenothing") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t036",targetState="stoppedwhilenothing",cond=whenDispatch("stopplan"))
					transition(edgeName="t037",targetState="work",cond=whenDispatch("continueplan"))
				}	 
				state("execplan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t038",targetState="nextMove",cond=whenTimeout("local_tout_planexec_execplan"))   
				}	 
				state("nextMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t039",targetState="doMove",cond=whenDispatch("nextmove"))
				}	 
				state("doMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t040",targetState="planinterruptedalarm",cond=whenDispatch("stopplan"))
					transition(edgeName="t041",targetState="planend",cond=whenDispatch("nomoremove"))
					transition(edgeName="t042",targetState="nextMove",cond=whenDispatch("nextmove"))
					transition(edgeName="t043",targetState="nextMove",cond=whenReply("stepdone"))
					transition(edgeName="t044",targetState="planinterruptedobstacle",cond=whenReply("stepfailed"))
				}	 
				...
				state("stopped") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="waitingforrestart45",targetState="stopped",cond=whenDispatch("stopplan"))
					transition(edgeName="waitingforrestart46",targetState="moving",cond=whenDispatch("continueplan"))
				}	 
				state("moving") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t147",targetState="nextMove",cond=whenReply("stepdone"))
					transition(edgeName="t148",targetState="nextMove",cond=whenDispatch("nextmove"))
					transition(edgeName="t149",targetState="execplan",cond=whenRequest("doplan"))
				}	 
			}
		}
} 
