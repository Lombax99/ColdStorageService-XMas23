		...
		val interruptedStateTransitions = mutableListOf<Transition>()
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="gotoindoor",cond=whenReply("accept"))
					transition(edgeName="t07",targetState="tryagainlater",cond=whenReply("reject"))
				}	 
				state("tryagainlater") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="wait8",targetState="work",cond=whenTimeout("local_tout_serviceaccessgui_tryagainlater"))   
				}	 
				state("gotoindoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t29",targetState="giveticket",cond=whenTimeout("local_tout_serviceaccessgui_gotoindoor"))   
				}	 
				state("giveticket") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="tc10",targetState="checkresponse",cond=whenReply("ticketchecked"))
				}	 
