			...
			var Peso = 0
				...
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="ready6",targetState="work",cond=whenDispatch("robotready"))
				}	 
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="startworking7",targetState="startjob",cond=whenRequest("doJob"))
				}	 
				...
				state("movingtoarrival") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="gofetch8",targetState="movingtocoldroom",cond=whenReply("moverobotdone"))
				}	 
				state("movingtocoldroom") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="godrop9",targetState="checkforjob",cond=whenReply("moverobotdone"))
				}	 
				...
				state("waitforjob") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="gofetchagain10",targetState="goinghome",cond=whenTimeout("local_tout_transporttrolley_waitforjob"))   
					transition(edgeName="gofetchagain11",targetState="startjob",cond=whenRequest("doJob"))
				}	 
