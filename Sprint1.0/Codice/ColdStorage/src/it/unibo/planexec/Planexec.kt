		  ...
		  var Plan          = ""
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="execplan",cond=whenRequest("doplan"))
				}	 
				state("execplan") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="nextMove",cond=whenTimeout("local_tout_planexec_execplan"))   
				...
				state("nextMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
					transition(edgeName="t016",targetState="doMove",cond=whenDispatch("nextmove"))
				}	 
				state("doMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t017",targetState="planinterruptedalarm",cond=whenEvent("alarm"))
					transition(edgeName="t018",targetState="planend",cond=whenDispatch("nomoremove"))
					transition(edgeName="t019",targetState="nextMove",cond=whenDispatch("nextmove"))
					transition(edgeName="t020",targetState="nextMove",cond=whenReply("stepdone"))
