		  ...
		  var StepSynchRes  = false
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t031",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t032",targetState="endwork",cond=whenDispatch("end"))
				}	 
